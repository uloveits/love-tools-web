...
import columnApi from "../../../services/api/column";
...
export default class AppNavigatePage extends React.Component {
  ...
  //获得链接下拉框
  getLinkInfo = async () => {
    let res = await columnApi.classifyList({});
    console.log('获得链接下拉框')
    console.log(res)
    if(res.code === '200') {
      this.setState({
      ...
      <div className='page-content'>
        ...
        >
          <div>
            ...
            <KtSeparator />
            <Row type="flex" justify="center" align="middle">
              <Col span={5} className='text-right pr10'><span className='major'>*</span>描述：</Col>
              <Col span={10}>
                <Input placeholder="请输入描述" onChange={onInputChange.bind(this,'param','des')} value={this.state.param.des}/>
              </Col>
            </Row>
            <KtSeparator />
            <Row type="flex" justify="center" align="middle">
            ...
            <Row type="flex" justify="center" align="middle">
              ...
              <Col span={10}>
                ...
                >
                  {
                    renderCommonSelectOption(this.state.linkSelect,'name')
                  }
                </Select>
              </Col>
            </Row>
