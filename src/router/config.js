...
//栏目管理
import _column_classify from '../pages/column/classify';//栏目分类
//商品管理
...
export default {
  ...
  _app_article_edit,_app_navigate,_app_contact,_column_classify,_goods_classify,_goods_add,_goods_sku,
